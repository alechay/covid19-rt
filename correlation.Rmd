...
# Mobility data
mob <- read_csv('2020_CA_Region_Mobility_Report.csv')
mob <- mob %>% 
...
o_mob <- mob %>% 
  filter(sub_region_1=='Ontario' & is.na(sub_region_2))
p_mob <- mob %>% 
  filter(sub_region_1=='Ontario' & sub_region_2=='Regional Municipality of Peel')
t_mob <- mob %>% 
  filter(sub_region_1=='Ontario' & sub_region_2=='Toronto Division')
w_mob <- mob %>% 
  filter(sub_region_1=='Ontario' & sub_region_2=='Waterloo Regional Municipality')
y_mob <- mob %>% 
  filter(sub_region_1=='Ontario' & sub_region_2=='Regional Municipality of York')
```
...
w2 <- get_data(w_mob, w_rt, '2020-12-26', '2021-01-22', COLS)
y2 <- get_data(y_mob, y_rt, '2020-12-14', '2021-01-22', COLS)
```
...
write_csv(total_correlation, 'Correlation_Analysis/corr_coef.csv')
```
...
write_csv(total_regression, 'Correlation_Analysis/reg_coef.csv')
```

## Barplot
```{r}
p <- ggplot(total_regression, aes(x=place, y=coefficient, fill=mobility)) +
...
ggsave('Correlation_analysis/examples/ontario14.png',
       ont)
ggsave('Correlation_analysis/examples/toronto0.png',
       tor)
```
