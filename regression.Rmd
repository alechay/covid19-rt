...
dates <-  as.Date(c('2020-03-17', '2020-03-23', '2020-05-14', '2020-06-08', '2020-07-13', '2020-09-28', '2020-12-14', '2020-12-26'))

# times <- ontario %>%
#   filter(date_start %in% dates) %>%
#   select(t_start)

segmented_regressions(ontario, 'Ontario fixed breaks', dates)
```

```{r}
segmented_regressions(ontario, 'Ontario default breaks')
```
...
segmented_regressions(peel, 'Peel fixed breaks', dates)
```

```{r}
segmented_regressions(peel, 'Peel default breaks')
```
...
12/14/20	Grey  
```{r}
dates <- as.Date(c('2020-03-17', '2020-03-23', '2020-06-24', '2020-11-14', '2020-11-20', '2020-12-14'))

segmented_regressions(toronto, 'Toronto fixed breaks', dates)
```

```{r}
segmented_regressions(toronto, 'Toronto default breaks')
```
...
12/26/20	Grey
```{r}
dates <- as.Date(c('2020-03-17', '2020-03-25', '2020-06-12', '2020-07-13', '2020-09-22', '2020-11-03', '2020-11-16', '2020-12-26'))

segmented_regressions(waterloo, 'Waterloo fixed dates', dates)
```

```{r}
segmented_regressions(waterloo, 'Waterloo default dates')
```
...
12/14/20	Grey Level  
```{r}
dates <- as.Date(c('2020-03-17', '2020-05-19', '2020-06-19', '2020-07-24', '2020-10-19', '2020-11-06', '2020-11-16', '2020-12-14'))

segmented_regressions(york, 'York fixed dates', dates)
```

```{r}
segmented_regressions(york, 'York default dates')
```
