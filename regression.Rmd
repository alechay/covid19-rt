...
res <- segmented_regressions(ontario, 'Ontario fixed breaks', breaks)
...
res <- segmented_regressions(peel, 'Peel fixed breaks', breaks)
...
res <- segmented_regressions(toronto, 'Toronto fixed breaks', breaks)
...
res <- segmented_regressions(waterloo, 'Waterloo fixed dates', breaks)
...
res <- segmented_regressions(york, 'York fixed dates', breaks)
