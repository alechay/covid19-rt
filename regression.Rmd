...
ggsave('Breakpoint_Graphs/Ontario_Fixed_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Ontario_Fixed_Breaks.csv')
res$plot
df
```
...
df <- regression_eqs(ontario, res$my.seg, res$breaks)
ggsave('Breakpoint_Graphs/Ontario_Default_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Ontario_Default_Breaks.csv')
res$plot
df
```
...
ggsave('Breakpoint_Graphs/Peel_Fixed_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Peel_Fixed_Breaks.csv')
res$plot
df
```
...
df <- regression_eqs(peel, res$my.seg, res$breaks)
ggsave('Breakpoint_Graphs/Peel_Default_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Peel_Default_Breaks.csv')
res$plot
df
```
...
ggsave('Breakpoint_Graphs/Toronto_Fixed_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Toronto_Fixed_Breaks.csv')
res$plot
df
```
...
df <- regression_eqs(toronto, res$my.seg, res$breaks)
ggsave('Breakpoint_Graphs/Toronto_Default_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Toronto_Default_Breaks.csv')
res$plot
df
```
...
ggsave('Breakpoint_Graphs/Waterloo_Fixed_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Waterloo_Fixed_Breaks.csv')
res$plot
df
```
...
df <- regression_eqs(waterloo, res$my.seg, res$breaks)
ggsave('Breakpoint_Graphs/Waterloo_Default_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/Waterloo_Default_Breaks.csv')
res$plot
df
```
...
ggsave('Breakpoint_Graphs/York_Fixed_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/York_Fixed_Breaks.csv')
res$plot
df
```
...
df <- regression_eqs(york, res$my.seg, res$breaks)
ggsave('Breakpoint_Graphs/York_Default_Breaks.png', 
       res$plot,
       height = 5,
       width = 10,
       units = 'in')
write_csv(df, 'Breakpoint_Data/York_Default_Breaks.csv')
res$plot
df
```
