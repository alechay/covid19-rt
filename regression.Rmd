...
ont_fix_plot <- res$plot + 
  ...
  annotate('rect', xmin=df$break_start[3], xmax=df$break_end[4],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.3) +
  annotate('rect', xmin=df$break_start[5], xmax=df$break_end[7],
         ymin=-Inf, ymax=+Inf,
         fill='green', alpha=0.2) +
  annotate('rect', xmin=df$break_start[8], xmax=df$break_end[10],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.1) +
  geom_vline(breaks,
             mapping = aes(xintercept=Date),
...
peel_fix_plot <- res$plot +
  annotate('rect', xmin=df$break_start[2], xmax=df$break_end[2],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.3) +
  annotate('rect', xmin=df$break_start[3], xmax=df$break_end[5],
           ymin=-Inf, ymax=+Inf,
           fill='green', alpha=0.2) +
  annotate('rect', xmin=df$break_start[6], xmax=df$break_end[8],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.1) +
  geom_vline(breaks,
             mapping = aes(xintercept=Date),
...
tor_fix_plot <- res$plot +
  ...
  annotate('rect', xmin=df$break_start[3], xmax=df$break_end[3],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.3) +
  annotate('rect', xmin=df$break_start[4], xmax=df$break_end[5],
           ymin=-Inf, ymax=+Inf,
           fill='green', alpha=0.2) +
  annotate('rect', xmin=df$break_start[6], xmax=df$break_end[8],
         ymin=-Inf, ymax=+Inf,
...
wat_fix_plot <- res$plot +
  ...
  annotate('rect', xmin=df$break_start[3], xmax=df$break_end[3],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.3) +
  annotate('rect', xmin=df$break_start[4], xmax=df$break_end[6],
           ymin=-Inf, ymax=+Inf,
           fill='green', alpha=0.2) +
  annotate('rect', xmin=df$break_start[7], xmax=df$break_end[10],
         ymin=-Inf, ymax=+Inf,
         fill='red', alpha=0.1) +
  geom_vline(breaks,
             mapping = aes(xintercept=Date),
...
york_fix_plot <- res$plot +
  annotate('rect', xmin=df$break_start[2], xmax=df$break_end[2],
           ymin=-Inf, ymax=+Inf,
           fill='red', alpha=0.3) +
  annotate('rect', xmin=df$break_start[3], xmax=df$break_end[6],
           ymin=-Inf, ymax=+Inf,
           fill='green', alpha=0.2) +
  annotate('rect', xmin=df$break_start[7], xmax=df$break_end[10],
         ymin=-Inf, ymax=+Inf,
